...
public interface MRJobConfig {
  ...
  /** Default value for maximum copies of the tasks*/
  public static final String MR_CLONE_ATTEMPTS_COPYIES_LIMIT_KEY = "mapreduce.clonecopies";
  public static final int DEFAULT_MR_CLONE_ATTEMPTS_COPYIES_LIMIT_KEY = 4;
  /** Default value for the weight of the tasks*/
  public static final String MR_CLONE_ATTEMPTS_WEIGHT_KEY = "mapreduce.weight";
  public static final int DEFAULT_MR_CLONE_ATTEMPTS_WEIGHT_KEY = 1;
  /** Default value for the workload ratio of the tasks*/
  public static final String MR_CLONE_ATTEMPTS_WORKLOAD_RATIO_KEY = "mapreduce.workload.ratio";
  public static final int DEFAULT_MR_CLONE_ATTEMPTS_WORKLOAD_RATIO_KEY = 1;
  /** Default value for the mapper number of the tasks*/
  public static final String MR_CLONE_ATTEMPTS_MAPPER_NUM_KEY = "mapreduce.mapper-number";
  public static final int DEFAULT_MR_CLONE_ATTEMPTS_MAPPER_NUM_KEY = 30;
}
