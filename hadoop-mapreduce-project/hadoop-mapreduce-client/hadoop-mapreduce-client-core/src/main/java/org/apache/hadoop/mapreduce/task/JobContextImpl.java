...
public class JobContextImpl implements JobContext {
   ...
   * will be made to run a task, as specified by the <code>mapred.task.max.copies</code>
   * property. If this property is not already set, the default is 4 attempts.
   *  
   * @return the max number of attempts per map task.
   */
  public int getNumCloneCopies() {
    return conf.getNumCloneCopies();
  }

  /** 
   * Get the configured number of weight that 
   * will be made to run a job, as specified by the <code>mapred.task.weight</code>
   * property. If this property is not already set, the default is 1.
   *  
   * @return the weight per job.
   */
  public int getWeight() {
    return conf.getWeight();
  }
  
  /** 
   * Get the configured number of mapper that 
  ...
  public int getMapperNumber() {
    return conf.getMapperNumber();
  }

  /** 
   * Get the configured number of workload ratio of task that 
   * will be made to run a task, as specified by the <code>mapred.task.workloadratio</code>
