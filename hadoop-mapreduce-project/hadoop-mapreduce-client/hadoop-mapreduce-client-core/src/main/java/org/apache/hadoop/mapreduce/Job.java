...
public class Job extends JobContextImpl implements JobContext {  
  ...
  /**
   * Set the number of clone copies for the job
   * @param number the number of clone copies number
   * @throws IllegalStateException if the job is submitted
   */
  public void setNumCloneCopies(int number) throws IllegalStateException {
	    ensureState(JobState.DEFINE);
	    conf.setNumCloneCopies(number);
  }
  /**
   * Set the number of weight for the job
   * @param number the number of job weight
   * @throws IllegalStateException if the job is submitted
   */
  public void setWeight(int weight) throws IllegalStateException {
	    ensureState(JobState.DEFINE);
	    conf.setWeight(weight);
  }
  /**
   * Set the number of task workload ratio
   * @param number the number of task workload ratio
   * @throws IllegalStateException if the job is submitted
   */
  public void setWorkloadRatio(int ratio) throws IllegalStateException {
	    ensureState(JobState.DEFINE);
	    conf.setWorkloadRatio(ratio);
  }
  /**
   * Set the number of mapper for the job
   * @param number the number of job mapper
   * @throws IllegalStateException if the job is submitted
   */
  public void setMapperNumber(int mapperNum) throws IllegalStateException {
	    ensureState(JobState.DEFINE);
	    conf.setMapperNumber(mapperNum);
  }
