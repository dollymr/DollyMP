...
public class JobConf extends Configuration {
  ...
  /** 
   * Get the configured number of maximum number of task clone copies that 
   * will be made to run a task, as specified by the <code>mapreduce.task.copiesnumber</code>
   * property. If this property is not already set, the default is 4 attempts.
   *  
   * @return the max number of copies per task.
   */
  
  public int getNumCloneCopies() {
	  return getInt(JobContext.MR_CLONE_ATTEMPTS_COPYIES_LIMIT_KEY, 4);
  }
  
  /** 
   * Set the configured number of maximum number of task clone copies that
   * will be made to run a task, as specified by the <code>mapreduce.task.copiesnumber</code>
   * property. If this property is not already set, the default is 4 attempts.
   *  
   * @param the max number of attempts per map task.
   */
  
  public void setNumCloneCopies(int n) {
	  setInt(JobContext.MR_CLONE_ATTEMPTS_COPYIES_LIMIT_KEY, n);
  }
  
  /** 
   * Get the configured number of weight that 
   * will be made to run a job, as specified by the <code>mapreduce.task.weight</code>
   * property. If this property is not already set, the default is 1.
   *  
   * @return the weight per job.
   */
  
  public int getWeight() {
	  return getInt(JobContext.MR_CLONE_ATTEMPTS_WEIGHT_KEY, 1);
  }
  
  /** 
   * Set the configured number of weight that 
   * will be made to run a job, as specified by the <code>mapreduce.task.weight</code>
   * property. If this property is not already set, the default is 1.
   *  
   * @param the weight per job.
   */
  
  public void setWeight(int n) {
	  setInt(JobContext.MR_CLONE_ATTEMPTS_WEIGHT_KEY, n);
  }
  
  /** 
   * Get the configured number of mapper number that 
   * will be made to run a job, as specified by the <code>mapreduce.mapper-number</code>
   * property. If this property is not already set, the default is 30.
   *  
   * @return the mapper number per job.
   */
  
  public int getMapperNumber() {
	  return getInt(JobContext.MR_CLONE_ATTEMPTS_MAPPER_NUM_KEY, 30);
  }
  
  /** 
   * Set the configured number of mapper number that 
   * will be made to run a job, as specified by the <code>mapreduce.mapper-number</code>
   * property. If this property is not already set, the default is 30.
   *  
   * @param the mapper number per job.
   */
  
  public void setMapperNumber(int n) {
	  setInt(JobContext.MR_CLONE_ATTEMPTS_MAPPER_NUM_KEY, n);
  }
  
  /** 
   * Get the configured number of workload ratio of task that 
   * will be made to run a task, as specified by the <code>mapreduce.task.workloadratio</code>
   * property. If this property is not already set, the default is 999999999.
   *  
   * @return the workloadratio per task.
   */
  
  public int getWorkloadRatio() {
	  return getInt(JobContext.MR_CLONE_ATTEMPTS_WORKLOAD_RATIO_KEY, 999999999);
  }
  
  /** 
   * Set the configured number of workload ratio of task that 
   * will be made to run a task, as specified by the <code>mapreduce.task.workloadratio</code>
   * property. If this property is not already set, the default is 999999999.
   *  
   * @param the workloadratio per task.
   */
  
  public void setWorkloadRatio(int n) {
	  setInt(JobContext.MR_CLONE_ATTEMPTS_WORKLOAD_RATIO_KEY, n);
  }
