...
public class MapTask extends Task {
 ...
 private <T> T getSplitDetails(Path file, long offset) 
  ...
  private <KEY, VALUE> MapOutputCollector<KEY, VALUE>
    ...
    LOG.info("collectorClasses name is " + job.getStrings(JobContext.MAP_OUTPUT_COLLECTOR_CLASS_ATTR, "MapOutputCollector"));
    count++;
    int remainingCollectors = collectorClasses.length;
    count++;
    for (Class clazz : collectorClasses) {
      try {
        LOG.info("MapOutputCollector class is " + clazz.getClass());
    	count++;
        ...
        String msg = "Unable to initialize MapOutputCollector " + clazz.getName() + " , ERROR COUNT = " + count + " remainingCollectors = " + remainingCollectors;
    ...
    throw new IOException("Unable to initialize any output collector, ERROR COUNT = " + count  + " remainingCollectors = " + remainingCollectors);
  }
