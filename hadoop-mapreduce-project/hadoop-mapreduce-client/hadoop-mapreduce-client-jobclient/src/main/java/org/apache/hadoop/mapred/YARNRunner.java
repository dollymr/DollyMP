...
public class YARNRunner implements ClientProtocol {
  ...
  public ApplicationSubmissionContext createApplicationSubmissionContext(
    ...
    //Han comment: This is for the AM SRPT, we need to know the workload and mapper number at the first time.
    appContext.setWorkloadRatio((long)
    	conf.getInt(MRJobConfig.MR_CLONE_ATTEMPTS_WORKLOAD_RATIO_KEY,
    	    MRJobConfig.DEFAULT_MR_CLONE_ATTEMPTS_WORKLOAD_RATIO_KEY));
    appContext.setMapperNumber(
        conf.getInt(MRJobConfig.MR_CLONE_ATTEMPTS_MAPPER_NUM_KEY,
        	MRJobConfig.DEFAULT_MR_CLONE_ATTEMPTS_MAPPER_NUM_KEY));
    appContext.setWeight(
