...
public abstract class AbstractCSQueue implements CSQueue {
  ...
  //this is the unscheduled effective workload of the leaf queue
  protected long queueFinishTime;
  protected long queueWeight;
  ...
  public AbstractCSQueue(CapacitySchedulerContext cs, 
      ...
      long finishTime, long weight) throws IOException {
  	this.queueFinishTime = finishTime;
