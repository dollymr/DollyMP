    ...
    public RMAppState transition(RMAppImpl app, RMAppEvent event) {
      ...
      if (app.attempts.isEmpty()) {
        app.scheduler.handle(new AppAddedSchedulerEvent(app.applicationId,
          app.submissionContext.getQueue(), app.user, false,
          app.submissionContext.getReservationID(), 
          app.submissionContext.getWorkloadRatio(), 
          app.submissionContext.getMapperNumber(), 
          app.submissionContext.getWeight())); //TODO: update weight here.
        return RMAppState.SUBMITTED;
      }

      // Add application to scheduler synchronously to guarantee scheduler
      // knows applications before AM or NM re-registers.
      //TODO: need to update the weight after we add weight in the application submission
      // context.
      app.scheduler.handle(new AppAddedSchedulerEvent(app.applicationId,
