...
package org.apache.hadoop.yarn.server.resourcemanager.scheduler.common.fisrpt;
...
import org.apache.hadoop.yarn.server.resourcemanager.scheduler.srptmsc.CapacityHeadroomProvider;
import org.apache.hadoop.yarn.server.resourcemanager.rmapp.RMApp;

/**
 * Represents an application attempt from the viewpoint of the FIFO or SRPTMS+C
 * scheduler.
 */
@Private
@Unstable
public class FiCaSchedulerApp extends SchedulerApplicationAttempt {
  ...
  public FiCaSchedulerApp(ApplicationAttemptId applicationAttemptId, 
      String user, Queue queue, ActiveUsersManager activeUsersManager,
      RMContext rmContext, long appFinishTime) {
    super(applicationAttemptId, user, queue, activeUsersManager, 
    		rmContext, appFinishTime);
  ...
  public FiCaSchedulerApp(ApplicationAttemptId applicationAttemptId, 
      String user, Queue queue, ActiveUsersManager activeUsersManager,
      RMContext rmContext, long appFinishTime, long weight) {
    super(applicationAttemptId, user, queue, activeUsersManager, 
    		rmContext, appFinishTime, weight);
  ...
  synchronized public RMContainer allocate(NodeType type, FiCaSchedulerNode node,
      ...
      Container container, boolean isForClone) {
    ...
    if (getTotalRequiredResources(priority) <= 0) {
      LOG.info("Hit the total required resources limit");
      return null;
    }
    ...
    List<ResourceRequest> resourceRequestList = appSchedulingInfo.allocate(
        type, node, priority, request, container, isForClone);
  ...
  public synchronized void setSRPTMSCHeadroomProvider(CapacityHeadroomProvider headroomProvider2) {
    this.headroomProvider = headroomProvider2;
  }
  ...
  @Override
  public synchronized boolean getIfHOSTCloneRound(){
	  return this.ifHOSTCloneRound;
  }
  @Override
  public synchronized void setIfHOSTCloneRound(boolean flag){
	  this.ifHOSTCloneRound = flag;
  }
  
  @Override
  public synchronized long getAppWeight(){
