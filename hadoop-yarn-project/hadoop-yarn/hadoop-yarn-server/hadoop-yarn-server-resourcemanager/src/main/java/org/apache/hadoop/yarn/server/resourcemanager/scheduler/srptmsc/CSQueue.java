...
extends org.apache.hadoop.yarn.server.resourcemanager.scheduler.Queue {
  ...
  /**
   * Get the unscheduled workload of the queue
   * @return current excepted finish time
   */
  public long getFinishTime();
  
  /**
   * Set the unscheduled workload of the queue
   * @param current excepted finish time
   */
  public void setFinishTime(long finishTime);
  
  /**
   * Get the weight of the queue
   * @return queue weight
   */
   ...
   * @param node node on which resources are available
   * @param needToUnreserve assign container only if it can unreserve one first
   * @param absoluteMaxAvailCapacity the percent of the deserved resource in cluster
   * @return the list of assignment
   */
  public List<CSAssignment> assignContainers(
