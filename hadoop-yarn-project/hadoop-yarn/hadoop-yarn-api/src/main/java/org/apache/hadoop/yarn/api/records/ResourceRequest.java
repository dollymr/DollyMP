...
public abstract class ResourceRequest implements Comparable<ResourceRequest> {
  ...
  public static ResourceRequest newInstance(Priority priority, String hostName,
	Resource capability, int numContainers, long workload, long copiesNumber, String TaskList) {
	return newInstance(priority, hostName, capability, numContainers, true, null, workload, copiesNumber, TaskList);
  }

  @Public
  @Stable
  public static ResourceRequest newInstance(Priority priority, String hostName,
      Resource capability, int numContainers, long workload, long copiesNumber) {
    return newInstance(priority, hostName, capability, numContainers, true, null, workload, copiesNumber, null);
  }	

  @Public
  @Stable
  public static ResourceRequest newInstance(Priority priority, String hostName,
      Resource capability, int numContainers, long workload) {
    return newInstance(priority, hostName, capability, numContainers, true, null, workload, 0, null);
  }

  @Public
  @Stable
  public static ResourceRequest newInstance(Priority priority, String hostName,
      Resource capability, int numContainers, boolean relaxLocality, long workload) {
    return newInstance(priority, hostName, capability, numContainers,
        relaxLocality, null, workload, 0, null);
  }
  /*****************************/
  @Public
  @Stable
  ...
  public static ResourceRequest newInstance(Priority priority, String hostName,
      Resource capability, int numContainers, boolean relaxLocality, 
      String labelExpression, long workload, long copiesNumber, String taskList) {
    ResourceRequest request = Records.newRecord(ResourceRequest.class);
    request.setPriority(priority);
    request.setResourceName(hostName);
    request.setCapability(capability);
  ...
  @Public
  @Stable  
  public abstract long getWorkload();
  
  public abstract void setWorkload(long workload);
  
public abstract int getWeight();
  
  public abstract void setWeight(int weight);
  
public abstract long getCopiesNumber();
  
  public abstract void setCopiesNumber(long copiesNumber);
  ...
  /**
   * Get the List of Task ID required with the given specifications.
   * @return List of Task ID required with the given specifications
   */
  @Public
  @Stable
  ...
  /**
   * Set the List of Task ID required with the given specifications
   * @param taskList List of Task ID required with the given 
   *                      specifications
   */
  @Public
  @Stable
  public abstract void setTaskList(String taskList);
