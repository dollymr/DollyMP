...
public abstract class ApplicationSubmissionContext {
  ...
  /**
   * Get the workload ratio set by client, we need this to generate the AM resource request
   * default is 999999999
   * 
   * @return the workload ratio
   */
  @Public
  public abstract long getWorkloadRatio();
  
  /**
   * Set the workload ratio set by client, we need this to generate the AM resource request
   * 
   * @param the workload ratio
   */
  @Public
  public abstract void setWorkloadRatio(long workloadRatio);
  
  /**
   * Get the mapper number set by client, we need this to generate the AM resource request
   * default is 30
   * 
  ...
  /**
   * Set the mapper number set by client, we need this to generate the AM resource request
   * 
   * @param the mapper number
   */
  @Public
  public abstract void setMapperNumber(int mapperNum);
  
  /**
   * Get the weight set by client, we need this to generate the AM resource request
   * default is 1
   * 
   * @return the weight
   */
  ...
  /**
   * Set the weight set by client, we need this to generate the AM resource request
   * 
   * @param the weight
   */
  @Public
