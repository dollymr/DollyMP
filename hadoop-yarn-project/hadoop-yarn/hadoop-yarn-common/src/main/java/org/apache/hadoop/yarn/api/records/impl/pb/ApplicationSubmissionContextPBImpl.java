...
extends ApplicationSubmissionContext {
  ...
  @Override
  public long getWorkloadRatio() {
    ApplicationSubmissionContextProtoOrBuilder p = viaProto ? proto : builder;
    return p.getWorkload();
  }

  @Override
  public void setWorkloadRatio(long workloadRatio) {
    maybeInitBuilder();
    builder.setWorkload(workloadRatio);
  }
  
  @Override
  public int getMapperNumber() {
    ApplicationSubmissionContextProtoOrBuilder p = viaProto ? proto : builder;
    return p.getMapperNumber();
  }

  @Override
  public void setMapperNumber(int mapperNum) {
    maybeInitBuilder();
    builder.setMapperNumber(mapperNum);
  }
