...
public long getWorkload() {
	ResourceRequestProtoOrBuilder p = viaProto ? proto : builder;
    return (p.getWorkload());// TODO Auto-generated method stub
...
public int getWeight() {
	ResourceRequestProtoOrBuilder p = viaProto ? proto : builder;
    return (p.getWeight());// TODO Auto-generated method stub
...
public long getCopiesNumber() {
	ResourceRequestProtoOrBuilder p = viaProto ? proto : builder;
    return (p.getCopiesNumber());// TODO Auto-generated method stub
...
public void setCopiesNumber(long copiesNumber) {
	 maybeInitBuilder();
	 builder.setCopiesNumber((copiesNumber));
}
@Override
public String getTaskList() {
	ResourceRequestProtoOrBuilder p = viaProto ? proto : builder;
    return (p.getTaskList());// TODO Auto-generated method stub
