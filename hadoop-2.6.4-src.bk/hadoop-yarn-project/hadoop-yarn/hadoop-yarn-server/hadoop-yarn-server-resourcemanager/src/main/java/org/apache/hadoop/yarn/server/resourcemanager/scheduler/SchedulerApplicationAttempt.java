...
//  protected long appFinishTime;
//  protected long appWeight = 1;
...
//    updateAppWeight();
  ...
  public SchedulerApplicationAttempt(ApplicationAttemptId applicationAttemptId, 
	  String user, Queue queue, ActiveUsersManager activeUsersManager,
	  RMContext rmContext, long finishTime) {
	Preconditions.checkNotNull("RMContext should not be null", rmContext);
    this.rmContext = rmContext;
...
//    updateAppFinishTime();
  ...
  public SchedulerApplicationAttempt(ApplicationAttemptId applicationAttemptId, 
      String user, Queue queue, ActiveUsersManager activeUsersManager,
      RMContext rmContext, long finishTime, long weight) {
    Preconditions.checkNotNull("RMContext should not be null", rmContext);
    this.rmContext = rmContext;
//    this.appFinishTime = finishTime;
//    this.appWeight = weight;
  ...
  public long getWorkload() {
	return appSchedulingInfo.getWorkload();
  }
  
  public long getAppWeight(){
	return appSchedulingInfo.getAppWeight();
  }
  public void setAMResource(Resource amResource) {
    this.amResource = amResource;
  }
  
  public void setWorkload(long time) {
	  appSchedulingInfo.setWorkload(time);
  }
  
  public void setAppWeight(long weight) {
	  appSchedulingInfo.setAppWeight(weight);
  }
