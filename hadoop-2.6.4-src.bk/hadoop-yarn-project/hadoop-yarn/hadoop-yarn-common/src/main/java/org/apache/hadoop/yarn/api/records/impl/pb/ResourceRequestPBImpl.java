...
public class ResourceRequestPBImpl extends ResourceRequest {
  ...
  public ResourceRequestPBImpl() {
	LOG.info("ResourceRequestPBImpl constructed with no args");
    builder = ResourceRequestProto.newBuilder();
  }

  public ResourceRequestPBImpl(ResourceRequestProto proto) {
	LOG.info("ResourceRequestPBImpl constructed with args");
    this.proto = proto;
    viaProto = true;
  }
...
//	LOG.info("request impl: getNumContainers called!");
    ResourceRequestProtoOrBuilder p = viaProto ? proto : builder;
...
//	LOG.info("request impl: getWorkload called!");
  	ResourceRequestProtoOrBuilder p = viaProto ? proto : builder;
